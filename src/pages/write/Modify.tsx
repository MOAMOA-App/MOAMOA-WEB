...
function Modify() {
    ...
    const goodData = useProductValue();
    ...
    return (
        <S.Wrap onSubmit={handleSubmit(onSubmit)}>
            ...
            <S.ContentCont>
                ...
                <div>
                    <S.Inp
                        ...
                        id="scales"
                        required
                        defaultValue={goodData.sellPrice}
                        {...register("sellPrice")}
                    />
                    원
                </div>
                ...
                <S.CountBox>
                    <S.Inp
                        ...
                        required
                        {...register("maxCount")}
                        defaultValue={goodData.maxCount}
                    />
                    개
            ...
            <S.TextArea
                ...
                defaultValue={goodData.description}
            />
            <S.Wrap2>
                <div className="second1">
                    ...
                    <S.InpCont>
                        <S.Inp2
                            ...
                            defaultValue={goodData.sellingArea}
                        />
                    ...
                    <S.InpCont>
                        <S.Inp2
                            ...
                            defaultValue={goodData.detailArea}
                            {...register("detailArea")}
                        />
                    </S.InpCont>
                </div>
